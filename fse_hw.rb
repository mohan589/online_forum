# Full Stack Engineer -- Online Forum Take Home Assignment
...
# Using an MVC framework (Ruby on Rails + Vue is preferable), please submit a web application that satisfies the user-stories outlined below.
...
# c) As a user, I would like to post a comment on another user's comment, so that I can have side discussion.
